describe('Posts factory', function() {
  ...
  // The array of posts our factory will provide us
  ...
  // Load postServices module...
  beforeEach(angular.mock.module('postServices'));

  // Set injected Post factory (_Posts_) to our local Posts variable
  ...
  describe('.getPosts()', function() {
    ...
    // Verify all() returns the array of posts
    it('should return a list of posts', function() {

      expect(Posts.getPosts()).toEqual(thePosts);
